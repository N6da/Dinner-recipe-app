...
var recipes = [{
        ...
        image: "caesar salad with parmesan and croutons, fresh salad, food photography",
...
function switchTab() {
        ...
        for (var i = 0; i < recipes[currentIndex].ingredients.length; i++) {
            content += `
                <div class="d-flex gap-2 align-items-center p-2">
                    <div class="rounded-circle numbers">${i+1}</div>
                    <div><p class="mb-0">${recipes[currentIndex].ingredients[i]}</p></div>
                </div>
            `;
        }
        return `${content}`;
    ...
    if (activeTab === "instructions") {
        for (var i = 0; i < recipes[currentIndex].instructions.length; i++) {
            content += `<div class="d-flex text-body-secondary gap-2 align-items-center p-2">
                    <div class="rounded-4 fw-bold numbers2">${i+1}</div>
                    <div><p class="mb-0">${recipes[currentIndex].instructions[i]}</p></div>
                </div>
            `;
        }
        return `${content}`;
    ...
    if (activeTab === "nutrition") {
        return `
            <div class="d-flex justify-content-between gap-3 nutrition-row w-100 mt-3">
                <div class="d-flex justify-content-between w-50 rounded-3 p-3 bg-body-tertiary align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(255, 234, 195);">
                            <i class="fa-solid fa-fire" style="color: #fd5600;"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Calories</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.calories}</p>
                    </div>
                </div>
                <div class="d-flex justify-content-between bg-body-tertiary p-3 w-50 rounded-3 align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(224, 236, 255);">
                            <i class="fa-solid fa-dumbbell" style="color: rgb(0, 97, 255);"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Protein</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.protein}</p>
                    </div>
                </div>
            </div>

           <div class="d-flex nutrition-row justify-content-between gap-3 w-100 mt-3">
                <div class="d-flex justify-content-between w-50 rounded-3 p-3 bg-body-tertiary align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(249, 250, 180);">
                            <i class="fa-brands fa-pagelines" style="color: rgb(219, 127, 0);"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Carbohydrates</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.carbs}</p>
                    </div>
                </div>

                <div class="d-flex justify-content-between bg-body-tertiary p-3 w-50 rounded-3 align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(255, 219, 220);">
                            <i class="fa-solid fa-droplet" style="color: rgb(222, 0, 69);"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Fat</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.fat}</p>
                    </div>
                </div>
            </div>

            <div class="d-flex nutrition-row justify-content-between gap-3 w-100 mt-3">
                <div class="d-flex justify-content-between w-50 rounded-3 p-3 bg-body-tertiary nutrition-content align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(214, 250, 227);">
                            <i class="fa-solid fa-seedling" style="color: rgb(34, 166, 0);"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Fiber</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.fiber}</p>
                    </div>
                </div>

                <div class="d-flex justify-content-between bg-body-tertiary nutrition-content p-3 w-50 rounded-3 align-items-center">
                    <div class="d-flex gap-3 align-items-center">
                        <div class="p-2 rounded-2" style="background-color: rgb(255, 226, 245);">
                            <i class="fa-solid fa-cube" style="color: rgb(232, 0, 102);"></i>
                        </div>
                        <p class="mb-0 fw-medium fs-6">Sodium</p>
                    </div>
                    <div>
                        <p class="mb-0 fw-bold">${recipes[currentIndex].nutrition.sodium}</p>
                    </div>
                </div>
        </div>
        `;
    ...
    if (activeTab === "tips") {
        if (recipes[currentIndex].tips && recipes[currentIndex].tips.length > 0) {
            for (var i = 0; i < recipes[currentIndex].tips.length; i++) {
                content += `<div class="p-4 tips-card rounded-3 tips mb-3 d-flex gap-2 align-items-center">
                                <div class="rounded-circle true d-flex flex-shrink-0 justify-content-center align-items-center"><i class="fa-solid fa-check" style="color: rgb(255, 255, 255);"></i></div>
                                ${recipes[currentIndex].tips[i]}
                            </div>`;
            }
            return `<div class="list-group border-bottom p-2" style="max-height: 700px;">${content}</div>`;
        }

        return `<p>No tips available for this recipe.</p>`;
    }
...
function displayRecipes() {
    var box = "";
    box = `
        <div class="row g-0 min-vh-100 rounded-3 shadow-lg">
            <div class="col-12 col-lg-5 position-relative">  
                <div class="recipe-info position-absolute bottom-0 img-content text-black bg-body-tertiary p-4 rounded-4 z-1 start-0 d-flex justify-content-around align-items-center m-4">
                    <div class="prep-time text-center">
                        <div class="d-flex justify-content-center align-items-center"><i class="fa-solid fa-clock info-icon" style="color: rgb(253, 86, 0);"></i></div>
                        <p class="mb-0 fs-6 text-secondary">Prep Time </p>
                        <p class="fw-bold mb-0">${recipes[currentIndex].prepTime}</p>
                    </div>  
                    <div class="prep-time text-center">
                        <div class="d-flex justify-content-center align-items-center"><i class="fa-solid fa-fire-burner info-icon" style="color: rgb(236, 46, 0);"></i></i></div>
                        <p class="mb-0 fs-6 text-secondary">Cook Time </p>
                        <p class="fw-bold mb-0">${recipes[currentIndex].cookTime}</p>
                    </div>  
                    <div class="prep-time text-center">
                        <div class="d-flex justify-content-center align-items-center"><i class="fa-solid fa-users info-icon" style="color: rgb(76, 95, 255); font-size:25px;"></i></div>
                        <p class="mb-0 fs-6 text-secondary">Servings</p>
                        <p class="fw-bold mb-0">${recipes[currentIndex].servings}</p>
                    </div>  
                </div>

                <div class="reviews position-absolute top-0 px-3 py-2 bg-body-tertiary rounded-5 start-0 m-4 z-1">
                    <div class="d-flex justify-content-around gap-2 align-items-center">
                        <i class="fa-solid fa-star" style="color: rgb(233, 202, 0);"></i>
                        <p class="mb-0">${recipes[currentIndex].ratingsAverage}</p>
                        <p class="text-secondary-emphasis mb-0 fw-light">(${recipes[currentIndex].ratingsQuantity} reviews) </p>
                    </div>  
                </div>     
                <img src="${recipes[currentIndex].imgCover}" 
                     class="img-fluid rounded-start imgRecipe object-fit-cover position-sticky w-100 h-100" 
                     alt="imgRecipe">
            </div>

            <div class="col-12 col-lg-7 details p-4">
                <div class="card-body">
                    <div class="d-flex gap-2 w-50">
                        <div class="rounded-3 flex-wrap gap-2 diffculty"><p class="fw-bold">${recipes[currentIndex].difficulty}</p></div>
                        <div class="rounded-3 flex-wrap gap-2 category"><p class="fw-bold">${recipes[currentIndex].category}</p></div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title fs-3 fs-lg-2 fw-bold">${recipes[currentIndex].name}</h3>
                            <p class="card-text text-secondary fs-6 fw-normal">${recipes[currentIndex].description}</p>
                        </div>
                        <div class="share d-flex gap-2 align-items-center">
                            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center p-3 rounded-3" style ="background-color :rgb(255, 245, 228);"><i class="fa-solid fa-bookmark" style="color: rgb(253, 86, 0); font-size:20px;"></i></div>
                            <div class="d-flex  flex-column flex-md-row justify-content-center align-items-center p-3 rounded-3" style ="background-color :rgb(255, 245, 228);"><i class="fa-solid fa-share-nodes" style="color: rgb(253, 86, 0); font-size:20px;"></i></div>
                        </div>
                    </div>
                   ${recipes[currentIndex].totalTime >= 45 ? `
                        <div class="p-2 rounded-3 mt-3 mb-0 warn d-flex gap-3 align-items-center">
                            <div>
                                <i class="fa-solid fa-triangle-exclamation" style="color: rgb(237, 47, 0); font-size : 20px;"></i>
                            </div>
                            <div class="mb-0">
                                 <p class="fw-bold mb-0 mt-0" style="color: rgb(161, 0, 32);">Extended Preparation Time</p>
                                <p class="mt-0 fw-light" style="color: rgb(230, 46, 83);">This recipe requires more than 45 minutes to prepare. Plan accordingly!</p>
                            </div>
                         </div>
                    ` : " "}
                ...
                <div class="d-flex  gap-0 border-bottom m-3 p-3 items">
                    <div class="d-flex gap-0 ingredients align-items-center" id="ingredientsTab">
                        <button class="btn" onclick="changeTab('ingredients')">
                            <i class="fa-solid fa-list-check"></i>
                            Ingredients
                        </button>
                    </div>

                    <div class="d-flex gap-0 ingredients align-items-center" id="instructionsTab"> 
                        <button class="btn" onclick="changeTab('instructions')">
                            <i class="fa-solid fa-book-open"></i>
                            Instructions
                        </button>
                    </div>

                    <div class="d-flex gap-0 ingredients align-items-center" id="nutritionTab">
                        <button class="btn" onclick="changeTab('nutrition')">
                            <i class="fa-solid fa-chart-pie"></i>
                            Nutrition
                        </button>
                    </div>

                    <div class="d-flex gap-0 flex-column ingredients align-items-center" id="tipsTab">
                        <button class="btn" onclick="changeTab('tips')">
                ...
                <div class="m-3 p-4 rounded recipe-content  ${activeTab === 'ingredients' ? 'content' : ''}" id="recipeContent">
                    ${switchTab()}
                </div>


                <button class="changeBtn px-1 py-3 rounded-4 w-50 mx-4 my-3 text-white" onclick="changeRecipe()" id="changeRecipeBtn">
                    <i class="fa-solid fa-arrows-rotate" style="color: rgb(255, 255, 255);"></i>
                    Try Another Recipe
                </button>
            </div>
        </div>
...
function ActiveTab() {
    ...
    var nutritionTab = document.getElementById("nutritionTab");
    var tipsTab = document.getElementById("tipsTab");

    ingredientsTab.classList.remove("active");
    instructionsTab.classList.remove("active");
    nutritionTab.classList.remove("active");
    tipsTab.classList.remove("active");
